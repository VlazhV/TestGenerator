...
namespace TestGenerator.Tests
{
	...
	public class CoreTests
	{
		...
		[TestMethod]
		public void GenerateInnerNamespaceTest()
		{
			var code = @"
				namespace Math
				{
					public class SimpleAriphmetics
					{
						public int Multiply(int x, int y)
						{
							return x * y;
					...
					namespace Complex
					{
						public class ComplexAriphmetics
						{
			...
			Assert.AreEqual( 2, fileCodePairs.Count );
			Assert.IsTrue( fileCodePairs.ContainsKey( "SimpleAriphmeticsTest.cs" ) );
			Assert.IsTrue( fileCodePairs.ContainsKey( "ComplexAriphmeticsTest.cs" ) );

			var testCode = fileCodePairs[ "SimpleAriphmeticsTest.cs" ];
			Assert.IsTrue( testCode.Contains( "using Microsoft.VisualStudio.TestTools.UnitTesting;" ) );
			Assert.IsTrue( testCode.Contains( "using Math;" ) );

			Assert.IsTrue( testCode.Contains( "namespace Math.Test" ) );
			Assert.IsTrue( testCode.Contains( "public class SimpleAriphmeticsTest" ) );
			Assert.IsTrue( testCode.Contains( "public void SumTest()" ) );
			Assert.IsTrue( testCode.Contains( "public void MultiplyTest()" ) );
			Assert.IsTrue( testCode.Contains( "Assert.Fail(\"autogenerated\")" ) );


			testCode = fileCodePairs[ "ComplexAriphmeticsTest.cs" ];
			Assert.IsTrue( testCode.Contains( "using Microsoft.VisualStudio.TestTools.UnitTesting;" ) );
			Assert.IsTrue( testCode.Contains( "using Math.Complex;" ) );

			Assert.IsTrue( testCode.Contains( "namespace Math.Complex.Test" ) );
			Assert.IsTrue( testCode.Contains( "public class ComplexAriphmeticsTest" ) );
			Assert.IsTrue( testCode.Contains( "public void SumTest()" ) );
			Assert.IsTrue( testCode.Contains( "public void MultiplyTest()" ) );
			Assert.IsTrue( testCode.Contains( "Assert.Fail(\"autogenerated\")" ) );
